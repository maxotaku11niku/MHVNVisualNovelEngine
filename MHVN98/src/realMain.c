...
int realMain(void)
{
	...
	gdc_setpalettecolour(0x1, 0x7, 0x7, 0x7);
	gdc_setpalettecolour(0x2, 0xB, 0x3, 0xB);
	gdc_setpalettecolour(0x3, 0xF, 0x7, 0xF);
	gdc_setpalettecolour(0x4, 0x7, 0x1, 0x1);
	gdc_setpalettecolour(0x5, 0xD, 0x4, 0x4);
	gdc_setpalettecolour(0x6, 0xF, 0xB, 0x7);
	gdc_setpalettecolour(0x7, 0xC, 0xB, 0x3);
	gdc_setpalettecolour(0x8, 0x2, 0x7, 0x3);
	gdc_setpalettecolour(0x9, 0x5, 0xD, 0x5);
	gdc_setpalettecolour(0xA, 0x8, 0xF, 0x5);
	gdc_setpalettecolour(0xB, 0xF, 0xF, 0x6);
	gdc_setpalettecolour(0xC, 0x3, 0x3, 0xB);
	gdc_setpalettecolour(0xD, 0x3, 0xA, 0xF);
	gdc_setpalettecolour(0xE, 0x9, 0xF, 0xF);
